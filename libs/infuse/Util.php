...
class Util
{
	 ...
	 * @return mixed|null
	 */
    public static function array_value( $a = array(), $k = '' )
    {
        $a = (array) $a;
	 ...
	 * @param mixed $value
	 */
    public static function array_set(&$a, $key, $value)
    {
        $pieces = explode('.', $key);
	 ...
	 * @return string
	 */
    public static function seoify( $string, $maxLength = 150, $commonWords = array() )
    {
