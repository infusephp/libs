...
class Locale
{
	 ...
	 * @return string
	 */
    public function translate( $phrase, array $params = array(), $locale = false )
    {
        if( !$locale )
            $locale = $this->locale;
	 ...
	 * Alias for translate()
	 */
    public function t( $phrase, array $params = array(), $locale = false )
    {
	 ...
	 * @return string html
	 */
    public function timezoneOptions($selectedTimezone = '')
    {
