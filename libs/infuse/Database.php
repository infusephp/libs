...
class Database
{
	...
	*/
	public static function select( $tableName, $fields, $parameters = array(), $showQuery = false )
	{
		if( !self::initialize() )
			return false;
	...
	* @return int count
	*/
	public static function queryCounter($key = 'all')
	{
		if( !self::initialize() )
			return false;
	...
	*/
	 ...
	 */
	public static function insertBatch($tableName, $fields, $data)
	{
		if( !self::initialize() )
			return false;
	...
	* @return boolean true if successful
	*/
	public static function update($tableName, $data, $where = null, $showQuery = false)
	{
		if( !self::initialize() )
			return false;
	...
	* @return boolean true if successful
	*/
	public static function delete($tableName, $where, $showQuery = false)
	{
		if( !self::initialize() )
			return false;
